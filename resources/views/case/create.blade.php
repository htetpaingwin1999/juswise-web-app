                   ...
                   <form action="{{ route('problem.store') }}" method="POST">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea rows="6" class="form-control fs-5 @error('case_number')
                                is-invalid
                            @enderror" placeholder="အမှုအမှတ်စဉ်" name="case_number" required>{{ old('case_number') }}</textarea>
                            @error('case_number')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea rows="6" class="form-control fs-5 @error('allegation')
                                is-invalid
                            @enderror" placeholder="တရားစွဲဆိုသော/ပါရှိသောပုဒ်မ" name="allegation" required>{{ old('allegation') }}</textarea>
                             @error('allegation')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" class="form-control fs-5 @error('decision_date')
                                is-invalid
                            @enderror" placeholder="အမှုဆုံးဖြတ်သည့်နေ့အတိအကျ" value="{{ old('decision_date') }}" name="decision_date" required>
                            @error('decision_date')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea rows="12" class="form-control fs-5 @error('case_summary')
                                is-invalid
                            @enderror" placeholder="အမှုဖြစ်စဉ်အကျဉ်း" name="case_summary" required>{{ old('case_summary') }}</textarea>
                            @error('case_summary')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea rows="12" class="form-control fs-5 @error('decision')
                                is-invalid
                            @enderror" placeholder="အမှုဖြစ်စဉ်အကျဉ်း" name="decision" required>{{ old('decision') }}</textarea>
                            @error('decision')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" class="form-control fs-5 @error('instance')
                                is-invalid
                            @enderror" placeholder="ဆုံးဖြတ်ချက်အမျိုးအစား" value="{{ old('instance') }}" name="instance" required>
                            @error('instance')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea rows="12" class="form-control fs-5 @error('conclusion')
                                is-invalid
                            @enderror" placeholder="ဆုံးဖြတ်ရာတွင် ထည့်သွင်းစဉ်းစားချက်များ" name="conclusion" required>{{ old('conclusion') }}</textarea>
                            @error('conclusion')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea rows="10" class="form-control fs-5 @error('related_case')
                                is-invalid
                            @enderror" placeholder="ဆက်စပ်သည်များ (အမှု/စာအုပ်)" name="related_case" required>{{ old('related_case') }}</textarea>
                            @error('related_case')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
