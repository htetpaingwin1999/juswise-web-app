                ...
                <div class="col">
                    ...
                    <div class="card shadow mb-3">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">Username & Email</p>
                        </div>
                        <div class="card-body">
                                    ...
                                    <div class="col">
                                        <div class="">
                                            ...
                                            <input class="form-control @error('name')
                                                is-invalid
                                            @enderror" type="text" id="username" placeholder="Username" value="{{ Auth::user()->name }}" name="name">
                                    ...
                                    <div class="col">
                                        <div class="">
                                            ...
                                            <input class="form-control @error('email')
                                                is-invalid
                                            @enderror" type="email" id="email" placeholder="user@example.com" value="{{ Auth::user()->email }}" name="email">
                        ...
                        <div class="card-body">
                            <form>
                                <div class="mb-3"><label class="form-label" ><strong>Address</strong></label>
                                    <input class="form-control" type="text" placeholder="eg.No(1).&nbsp;C[1], Tarmwe Gyi(က+ခ),&nbsp;TarMwe,&nbsp;Yangon" name="address">
                                </div>
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3">
                                            <label class="form-label" ><strong>Ph Number</strong></label>
                                            <input class="form-control" type="number" min="8"  placeholder="Enter Your Ph Number" name="phno">
                                        </div>
                                    </div>
                                </div>
